...
本项目是[vue2-elm](https://github.com/bailicangdu/vue2-elm)的ts实现版本，已征得作者[@bailicangdu](https://github.com/bailicangdu)同意，项目页面暂未完成，项目目前不支持scoped scss，工程使用的是.ts，.html，.scss三文件格式
...
```
git clone https://github.com/nuonuoge/vue2-elm-ts.git
...
>  另外一个 ionic + angular 的入门项目。[地址在这里](https://github.com/nuonuoge/ionic4_angular6_elm)


# 效果演示
暂无体验地址，可以去[vue-elm发布地址体验](http://cangdu.org/elm/)（请用chrome手机模式预览）
### 移动端扫描下方二维码
