 ...
 * 获取style样式
 */
export const getStyle = (element: any, attr: string, NumberMode = 'int') => {
  let target;
 ...
 * 页面到达底部，加载更多
 */
export const loadMore = (element: any, callback: Function) => {
 ...
 */
export const animate = (element: any, target: any, duration: any = 400, mode: any = 'ease-out', callback?: Function) => {
